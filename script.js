...
const I18N = {
  ua: {
    ...
    "platform.lead": "Hugo Media Group — це медійна платформа, побудована навколо персонального бренду Хуго.",
...
const PAGE_TITLES = {
  ua: {
    about: "Про Хуго — Hugo Media Group",
