...
const HUGO_PACKAGES = [
  {
    name: "Стартер",
    price: "300 €",
    note: "Щоб протестувати формат і побачити перші результати без великих вкладень."
  },
  {
    name: "Стандарт",
    price: "1 000 €",
    note: "Оптимальний формат: показати бізнес всередині й запустити стабільне зростання."
  },
  {
    name: "Максимум",
    price: "2 000 €",
    note: "Масштабна видимість і повна воронка залучення клієнтів із соцмереж."
  },
  {
...
const HUGO_MEDIA_ASSETS = [
  ...
  { platform: "Instagram", value: "1 100+", note: "підписників" },
